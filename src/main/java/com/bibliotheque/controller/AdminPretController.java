...
public class AdminPretController {
    ...
    public String updatePret(@PathVariable Long id,
        ...
        try {
            ...
            mettreAJourEtatExemplaire(pret);
    ...
    private void mettreAJourEtatExemplaire(PretLivre pret) {
        if (pret == null || pret.getExemplaire() == null || pret.getEtatPret() == null) {
            return;
        }
        String etatPret = pret.getEtatPret();
        if ("en_cours".equals(etatPret) || "en_retard".equals(etatPret)) {
            pret.getExemplaire().setEtat("en_pret");
        } else if ("retourne".equals(etatPret)) {
